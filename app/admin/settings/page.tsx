// This is the updated AccountSettings.tsx component with Slider for Platform Fee
// and full CRUD support for Manage Employees section, using generic DataTableCard
...
export default function AccountSettings() {
  ...
  const handleActionClick = (row: EmployeeRow, action: string) => {
    setSelectedRow(row);
  ...
  const handleDeleteConfirm = () => {
    ...
    setEmployees((prev) => prev.filter((emp) => emp.id !== selectedRow.id));
