...
const [products, setProducts] = useState<Product[]>([
  ...
  { id: 16, name: "Swimming Goggles", price: 28, selected: false, quantity: 60 },
  { id: 17, name: "Running Shorts", price: 22, selected: false, quantity: 140 },
  { id: 18, name: "Compression Shirt", price: 32, selected: false, quantity: 70 },
  { id: 19, name: "Boxing Gloves", price: 55, selected: false, quantity: 40 },
  { id: 20, name: "Knee Pads", price: 16, selected: false, quantity: 110 },
]);
  ...
  const recommendedSpotPrice = Math.ceil(
    (totalCost + platformFee) / parseInt(spotCount || "1")
  );
  const estimatedProfit =
    parseInt(spotPrice || "0") * parseInt(spotCount || "0") -
    totalCost -
    platformFee;
            ...
            <div className="xl:col-span-2 space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full mb-4 px-3 py-2 border border-[#C3D3E2] bg-[#F9FAFB] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#000000]"
                />
