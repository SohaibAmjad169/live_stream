...
interface AddEmployeeModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: (newEmployee: Omit<EmployeeRow, "id" | "dropdownActions">) => void;
}
      ...
      <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex justify-center items-center p-4">
        <div className="bg-white w-full max-w-2xl rounded-2xl p-6 sm:p-8 relative shadow-xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            ...
            />
            {errors.paymentType && (
              <p className="text-xs text-red-500 mt-1 col-span-1">{errors.paymentType}</p>
            )}
            ...
            />
            {errors.role && (
              <p className="text-xs text-red-500 mt-1 col-span-1">{errors.role}</p>
            )}
            ...
            <div className="col-span-1">
              <TextInput
                ...
                onChange={(e) =>
                  handleChange("rateValue", e.target.value.replace(/[^\d.]/g, ""))
                }
            ...
            />
            {errors.status && (
              <p className="text-xs text-red-500 mt-1 col-span-1">{errors.status}</p>
            )}
          </div>
