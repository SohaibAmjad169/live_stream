...
export default function AddInventoryItemModal({ isOpen, onClose, onSuccess }: Props) {
  ...
  const validate = () => {
    ...
    if (!quantity || isNaN(+quantity)) newErrors.quantity = "Enter valid number";
        ...
        <div className="bg-white w-full max-w-2xl rounded-2xl p-6 sm:p-8 relative shadow-xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            ...
            <div className="flex flex-col space-y-1">
              ...
              />
              {errors.manufacturer && (
                <p className="text-red-500 text-sm px-1">{errors.manufacturer}</p>
              )}
            </div>
